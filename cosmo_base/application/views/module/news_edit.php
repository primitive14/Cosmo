...
<div>
    <?php
      $attributes = array("class" => "form-horizontal", "id" => "newscreateform", "name" => "newscreateform");
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="form-group">
            <label>Subject</label>
            <input class="form-control" id="subject" name="subject" value="<?php echo $vn['subject']; ?>" type="text"/>
