...
<div class="container">
     <div class="row">
          ...
          <?php
            ...
            echo form_open("news/editNews", $attributes);
          ?>
          ...
          <fieldset>
               ...
               <div class="col-lg-8 col-sm-8">
                    <input class="form-control" id="title" name="title" placeholder="<?php echo $vn['title']; ?>" type="text"/>
               ...
               <div class="col-lg-8 col-sm-8">
                    <input class="form-control" id="subject" name="subject" placeholder="<?php echo $vn['subject']; ?>" type="text"/>
               ...
               <div class="col-lg-8 col-sm-8">
                  <input class="form-control" id="news" name="news" placeholder="<?php echo $vn['news']; ?>" type="text"/>
