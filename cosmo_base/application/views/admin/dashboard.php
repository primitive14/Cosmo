          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Report: November 2016 - December 2016</strong>
                  </p>
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Complaint Request</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Service Request</span>
            ...
            <div class="box-body">
              <form action="#" method="post">
                <div class="form-group">
                  <input type="email" class="form-control" name="emailto" placeholder="Title">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="subject" placeholder="Subject">
                </div>
                <div>
                  <textarea class="textarea" placeholder="Emergency News Content" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
              </form>
            </div>
            <div class="box-footer clearfix">
              <button type="button" class="pull-right btn btn-default" id="sendEmail">Post
