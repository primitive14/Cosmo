...
public function index(){
  ...
  $test4 ="admin";
  $expected_result4 = "admin";
  $test_name = 'Checking Service update';
  $this->unit->run($test2, $expected_result2, $test_name);
  
  $test_name="checking Inputing new user";
  $this->unit->run($test5,$expected_result5,$test_name);


  $test_name="Checking input news";
  $this->unit->run($test2,$expected_result2,$test_name);

  $test_name="Add visitor";
  $this->unit->run($test2,$expected_result2,$test_name);
  
  $test_name="Check visitor";
  $this->unit->run($test2,$expected_result2,$test_name);
