...
<head>
  ...
  -->
  <link rel="stylesheet" href="assests/dist/css/skins/skin-blue.min.css">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Some Guy</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Some Guy
                  <small>Member since Always</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-link"></i> <span>Complaint</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>Request Service</span></a></li>
