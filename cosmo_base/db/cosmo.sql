...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2016 at 05:51 PM
...
--
ALTER TABLE `complaint`
  MODIFY `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'unique ticket number';
--
...
--
ALTER TABLE `service`
  MODIFY `s_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'unique ticket number';
--
